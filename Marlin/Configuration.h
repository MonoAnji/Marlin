...
#define CUSTOM_MACHINE_NAME "PLArio"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.53, 80.53, 400, 105 } //105
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -17.5, -47, -1.20 }
...
#define NEOPIXEL_LED
  ...
  //#define NEOPIXEL_PIN     21      // LED driving pin
